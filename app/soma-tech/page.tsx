  ...
  <div class="container">
    <div class="contact-inner">
      ...
      <div class="contact-card reveal" style="transition-delay:.1s;">
        ...
        <form id="inquiryForm" action="https://script.google.com/macros/s/AKfycbxhzMhsKCDsu2KCi2GzvTYFUws5A8iJ1jfg7EajP3s2IUU-YvndtG3UsxKxYSrKY5T2Cg/exec" method="POST" target="hidden_iframe" class="contact-form">
          <div class="form-grid">
            <div class="form-row">
            ...
            <p class="form-note">We only use this information to reply to your inquiry. Your inquiry will be saved securely and used only so SOMA Tech can reply to you." target="_blank" rel="noopener">Telegram</a>.</p>
